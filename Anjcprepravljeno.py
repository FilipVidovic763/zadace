...
class Anjc:
    ...
    def igra(self):
        ...
        # pokušao sam da se igra dok ne budu sve karte izvucene ali ili preine kada dode preko 14 i ne ispise rezultat ili se igra sve dok ne pree 14 izvucenih 
        #moram još to doraditi ali nisam htio sada predat kod koji ne radi 
        if self.player_input=="vuci" and self.izvucene_karte<14:
            ...
            if self.bodovi_igrac== self.unos_broja_igraca  :
                print("---Čestitamo, pobijedili ste---")
                print("Igrač je odabrao broj {}".format(self.unos_broja_igraca))
                print("Komp je odabrao broj {}".format(self.kompjuter_odabir))
                print("-igrac je imao konacno {} bodova".format(self.bodovi_igrac))
                print("-Računalo je imalo konačno {}".format(self.komp_bodovi))
                return self.get_user_choice()
            elif self.komp_bodovi==self.kompjuter_odabir :
                print("---Računalo je pobijedilo---")
                print("Igrač je odabrao broj {}".format(self.unos_broja_igraca))
                print("Komp je odabrao broj {}".format(self.kompjuter_odabir))
                print("-igrac je imao konacno {} bodova".format(self.bodovi_igrac))
                print("-Računalo je imalo konačno {} bodova".format(self.komp_bodovi))
                return self.get_user_choice()
            elif self.bodovi_igrac>self.unos_broja_igraca :
                print("---Čestitamo, pobijedili ste---")
                print("Igrač je odabrao broj {}".format(self.unos_broja_igraca))
                print("Komp je odabrao broj {}".format(self.kompjuter_odabir))
                print("-igrac je imao konacno {} bodova".format(self.bodovi_igrac))
                ...
                print("-Računalo je imalo konačno {}".format(self.komp_bodovi))
                return self.get_user_choice()
            elif self.izvucene_karte>14:
                print("Sve karte su izvučene")
